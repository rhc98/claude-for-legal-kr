...
**현재 상태**: 2개 플러그인 포팅 완료 — `privacy-legal`(개인정보보호법 실무)과
`ai-governance-legal`(AI 거버넌스 실무 — AI 기본법 2026.1.22. 시행 + PIPA §37-2 자동화된
결정). 나머지 8개 플러그인은 [`docs/PORTING_GUIDE.md`](docs/PORTING_GUIDE.md) 가이드를 따라
동일한 패턴으로 한국화 가능합니다.
...
다른 8개 플러그인(commercial-legal, corporate-legal, employment-legal,
regulatory-legal, ip-legal, litigation-legal, law-student, legal-clinic)을
한국화하고 싶으신가요?
