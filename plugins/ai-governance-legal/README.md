...
> 조문 번호를 하드코딩하지 않고** 모든 인용을 법망 MCP로 조회·검증한 뒤 표시하며, 미검증
> 인용은 `[AI 기본법 현행 텍스트 대조 — 검증 필요]`로 플래그합니다.

**모든 출력은 변호사 검토 전제의 초안입니다** — 인용된 조문·판례는 법망 MCP로 검증해
...
- **AI 기본법은 2026.1.22. 시행 신법**입니다. 조문·시행령·고시가 빠르게 추가되므로 모든 인용은
  법망 MCP 또는 과기정통부 고시 대조가 필요하며, `references/currency-watch.md`를 자주 확인하세요.
...
- **과기정통부·PIPC AI 가이드라인, 행정 결정례는 법망에 포함되어 있지 않습니다.** 인용 시
